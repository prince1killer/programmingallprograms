<%@ Page Title="" Language="C#" MasterPageFile="~/Comon.master" AutoEventWireup="true" CodeFile="AddProfilePage.aspx.cs" Inherits="AddProfilePage" %>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control" required="required" data-validation-required-message="Please enter your Username." placeholder="Username" Enabled="False"></asp:TextBox>
                    <p class="help-block text-danger"></p>
                </div>

                <div class="form-group">
                    <asp:TextBox ID="TextBox8" runat="server" CssClass="form-control" required="required" data-validation-required-message="Please enter your Email Id." placeholder="Email Id" Enabled="False"></asp:TextBox>
                    <p class="help-block text-danger"></p>
                </div>
                <div class="form-group">
