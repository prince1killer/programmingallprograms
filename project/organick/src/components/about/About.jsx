        ...
        <div className='about'>
            ...
            <div className="about_about_us">
                <div>
                    ...
                    <div className="about_aboutus_dis">We do Creative Things for Success</div>
                    ...
                    <div>
                        <span>
                            <img src="images/Deliveryservices_icon3.png" alt="icon" /><label>Modern Agriculture Equipment</label>
                        </span>
                        <span>
                            <img src="images/Chemical Plantaboutus_icon2.png" alt="icon" /><label> No growth hormones are used</label>
                        </span>
                    </div>
            ...
            <div className="about_team">
                ...
                <div className="about_team_head">Our Organic Experts</div>
                <div className="about_team_dis">Simply dummy text of the printing and typesetting industry. Lorem had ceased to been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley.</div>
