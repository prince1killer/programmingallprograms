...
import './App.css'
import { CameraControls, Edges, Environment, MeshPortalMaterial, PivotControls, useGLTF } from '@react-three/drei'
...
//       <mesh castShadow rotation={rotation} geometry={nodes.Cube.geometry}>
    ...
    <Canvas shadows camera={{position:[-3,0.5,3]}}>
      <PivotControls anchor={[-1.1,-1.1,-1.1]} scale={0.75} lineWidth={3.5}>
        <mesh castShadow receiveShadow>
          ...
          <Side rotation={[0, Math.PI/2, Math.PI/2]} bg="aquamarine" index={1}>
