...
public partial class Show_Order : System.Web.UI.Page
{
    SqlConnection cn;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("select * from ordertable", cn);
        ...
        {
            cmd = new SqlCommand("delete from ordertable where id=@id", cn);
            cmd.Parameters.AddWithValue("@id", Request.QueryString["delete"]);

            cmd.ExecuteNonQuery();

            Response.Redirect("Show Order.aspx");
        }
    }
}