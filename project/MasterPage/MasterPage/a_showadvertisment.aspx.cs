...
public partial class a_showadvertisment : System.Web.UI.Page
{
    SqlConnection cn;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("select * from advertisment", cn);
        ...
        {
            cmd = new SqlCommand("delete from advertisment where id=@id", cn);
